...
@InputType()
class MaintenanceRecordCreateNestedManyWithoutFlightsInput {
...
export { MaintenanceRecordCreateNestedManyWithoutFlightsInput as MaintenanceRecordCreateNestedManyWithoutFlightsInput };
